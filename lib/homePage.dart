...
import 'package:meteoapp/dataset.dart';
import 'package:meteoapp/extraWeather.dart';
import 'detailPage.dart';

Weather currentTemp = Weather(min: 0, chanceRain: 0, max: 0, time: '', humidity: 0, name: '', day: '', location: '', image: '', wind: 0, current: 0);
Weather tomorrowTemp = Weather(min: 0, chanceRain: 0, max: 0, time: '', humidity: 0, name: '', day: '', location: '', image: '', wind: 0, current: 0);
...
class _homePageState extends State<homePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color(0xff09092b),
